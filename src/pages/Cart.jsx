    ...
    <div className="border-t border-gray-300 pt-13">
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <div className="flex gap-5 mt-2 items-center">
                    ...
                    <p className="bg-slate-50 px-2 sm:px-3 sm:py-1 border border-gray-300">
                      {item.size}
                    </p>
                  </div>
                </div>
      ...
      <div className="flex justify-end my-20">
        <div className="w-full sm:w-md">
          <CartTotal />
          <div className='w-full text-end py-7'>
            <Button onClick={()=>navigate('/place-order')} text={"Proceed to Checkout"} style={"!text-sm"} />
          </div>
        </div>
      </div>
    </div>
